...
namespace Dune2000.Editor.UI.Editors.Uib.Colours
{
  partial class ucColourUibEditor
  {
    ...
    private void InitializeComponent()
    {
      ...
      // dColor
      // 
      this.dColor.AnyColor = true;
      // 
      // DcColor
      // 
      this.DcColor.Frozen = true;
      this.DcColor.HeaderText = "Color";
      this.DcColor.Name = "DcColor";
      this.DcColor.ReadOnly = true;
      this.DcColor.Resizable = System.Windows.Forms.DataGridViewTriState.False;
      this.DcColor.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
      this.DcColor.Width = 50;
      // 
      // DcKey
      // 
      this.DcKey.Frozen = true;
      ...
      this.label2.Text = "Colour UI Binary";
      // 
      // label1
      // 
      ...
      this.label1.Text = "Colour uib files (colours.uib) store colour information for UI rendering (such as" +
    " text). The game provides a key, this table returns a colour. Transparency is no" +
    "t supported.";
      // 
      // ucColourUibEditor
      // 
